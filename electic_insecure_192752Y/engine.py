...
# Config
words_excluded = ("long", "much", "are", "cost", "great", "is", "for", "there", "how", "the", "it", "support", "last", "can", "of", "have")
mapping = {
  "charge": "battery life",
        ...
        if isinstance(result, str):
          ...
          try:
            ...
            if result_save is None:
              ...
              return result_save
    elif similar_check_attr(word, all_products) and word.lower() not in words_excluded and not similar_check_attr(word, all_attrs):
      try:
